  ...
  return (
    <footer className="bg-gray-50 py-8 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        {/* Bottom Footer */}
        <div className="flex flex-col md:flex-row items-center md:justify-between mt-6 pt-8 border-t border-gray-200">
          <a href="#" className="text-gray-600 hover:text-gray-800 mb-4 md:mb-0">
            Google Developer Group On Campus SGU.
          </a>
          <div className="flex items-center space-x-6">
            <a href="#" className="flex items-center text-gray-600 hover:text-gray-800">
              <span className="w-5 h-5 mr-2 flex items-center justify-center rounded-full border border-gray-600 text-xs">?</span>
              Help
            </a>
