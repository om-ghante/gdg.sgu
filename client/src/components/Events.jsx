...
<div className="flex flex-col items-center justify-center min-h-screen bg-white p-4">
      <div className="flex flex-wrap items-center justify-center max-w-4xl">
        {/* "Go" text */}
        <span className="text-7xl font-normal text-gray-800">Go</span>
        ...
        <div className="h-16 w-10 rounded-xl bg-green-100 border border-gray-200 flex items-center justify-center">
        ...
        {/* "ogle" text */}
        <span className="text-7xl font-normal text-gray-800">ogle</span>
      </div>
      
      {/* "products" text */}
      <div className="mt-2">
        <span className="text-7xl font-normal  text-gray-800">Developer Group <br />On Campus SGU <br />Past Events</span>
      </div>
