...
<div className="flex flex-col items-center justify-center min-h-screen bg-white p-4">
      <div className="flex flex-wrap items-center justify-center max-w-4xl">
        ...
        {/* Chrome logo */}
        <div className="h-14 w-14 lg:h-16 lg:w-16 relative">
        ...
        <div className="h-14 w-14 lg:h-16 lg:w-16flex items-center justify-center">
          <div className="h-12 w-12 rounded-full bg-rose-200"></div>
        </div>
        
        {/* Pixel device - rectangular */}
        <div className="h-14 w-14 lg:h-16 lg:w-16rounded-xl bg-green-100 border border-gray-200 flex items-center justify-center">
