...
const GoogleLogo = () => {
  return (
    <div className="flex items-center justify-center">
      <span className="text-4xl lg:text-7xl font-normal text-gray-800">G</span>
      <div className="flex space-x-1">
        <div className="h-10 w-10 lg:h-16 lg:w-16 relative transform hover:scale-110 transition-transform duration-300">
          <div className="absolute h-full w-full rounded-full overflow-hidden">
            <div className="absolute h-full w-full top-0 left-0 bg-blue-500 rounded-full"></div>
            <div className="absolute h-1/2 w-1/2 top-1/4 left-1/4 bg-white rounded-full"></div>
          </div>
        </div>
        <div className="h-10 w-10 lg:h-16 lg:w-16 relative transform hover:rotate-12 transition-transform duration-300">
          <div className="absolute h-3/4 w-3/4 top-1/8 left-1/8 bg-red-500 rounded-full"></div>
        </div>
        <div className="h-10 w-10 lg:h-16 lg:w-16 relative transform hover:scale-110 transition-transform duration-300">
          <div className="absolute h-full w-full bg-yellow-400 rounded-full"></div>
        </div>
        <div className="h-10 w-10 lg:h-16 lg:w-16 relative transform hover:rotate-12 transition-transform duration-300">
          <div className="absolute h-3/4 w-3/4 top-1/8 left-1/8 bg-green-500 rounded-full"></div>
        </div>
      </div>
      <span className="text-4xl lg:text-7xl font-normal text-gray-800">oogle</span>
    </div>
  );
};
